...
output.write("\t".join(["Peptide","PhyloCSF+1.score","PhyloCSF+2.score","PhyloCSF+3.score","PhyloCSF-1.score","PhyloCSF-2.score","PhyloCSF-3.score","PhyloCSF_prediction"])+"\n")

pep_scores={}

for r in regs:
    scoreList = [scores["+1"][r], scores["+2"][r], scores["+3"][r], scores["-1"][r], scores["-2"][r], scores["-3"][r]]
    seq = peptide[r]
